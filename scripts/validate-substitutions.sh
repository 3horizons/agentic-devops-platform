...
declare -A KNOWN_VARS=(
  ...
  ["GRAFANA_CLIENT_ID"]="Grafana Microsoft Entra ID app client ID"
  ["GRAFANA_CLIENT_SECRET"]="Grafana Microsoft Entra ID app client secret"
  ...
  ["RHDH_MANAGED_IDENTITY_CLIENT_ID"]="RHDH managed identity client ID"
