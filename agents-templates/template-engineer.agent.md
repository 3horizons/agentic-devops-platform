...
description: "RHDH Software Template expert — creates new Golden Path templates, converts existing repositories into reusable templates, generates devcontainer.json configurations, and integrates GitHub Codespaces into the scaffolder output."
tools:
  - search/codebase
  - edit/editFiles
...
10. **Handoff** — Suggest `@platform` for registration or `@platform` for portal configuration.
