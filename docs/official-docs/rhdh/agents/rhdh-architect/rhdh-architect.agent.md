...
This agent was created specifically to architect the **Three Horizons Developer Hub** portal customization. The reference template (`three-horizons-portal.html`) defines 11 pages with Microsoft branding. The implementation plan (`RHDH_Three_Horizons_Portal_Implementation_Plan.md`) maps each page to specific RHDH tasks and agents.
...
- 11-item sidebar navigation wiring
